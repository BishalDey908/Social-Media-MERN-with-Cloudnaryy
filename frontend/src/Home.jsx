...
const Home = () => {
  ...
  useEffect(()=>{
    axios.get("https://social-media-mern-backend-xi.vercel.app/api/showPost")
    .then((e)=>{
      // console.log(e.data)
      setPostData(e.data)
    })
  ...
  const handleLike = async (elem) => {
    ...
    try {
      const response = await axios.post(`https://social-media-mern-backend-xi.vercel.app/api/${elem._id}/like`,{username});
  ...
  const handleSave = (elem) =>{
    ...
    axios.post("https://social-media-mern-backend-xi.vercel.app/api/saved",{elem,savePostUserName})
    .then((res)=>{
  ...
  const handleShare = (elem) =>{
    ...
    axios.post("https://social-media-mern-backend-xi.vercel.app/api/sharePost",{img,postname,username,modDate,userPic,sharedUser,sharedTime})
    .then(()=>{
