...
const Comment = () => {
    ...
    const handleSubmit =()=>{
        ...
        axios.post("https://social-media-mern-backend-xi.vercel.app/api/addcomment",{username,postId,comment,modDate})
    .then((e)=>{
    ...
    // useEffect(()=>{
        let postId = localStorage.getItem('postId')
        axios.post("https://social-media-mern-backend-xi.vercel.app/api/getcomment",{postId})
        .then((e)=>{
            // console.log(e.data)
