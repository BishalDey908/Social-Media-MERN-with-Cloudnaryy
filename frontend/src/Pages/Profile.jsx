...
const Profile = () => {
  ...
  useEffect(()=>{
    ...
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/userPic",{username})
    .then((e)=>{
  ...
  useEffect(()=>{
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/userpost",{username})
    .then((e)=>{
  ...
  useEffect(()=>{
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/showFriends",{username})
    .then((data)=>{
  ...
  const  SetProfilePic = (post) =>{
    ...
    console.log(user)
      ...
      axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/setuserpic",{pic,user})
      .then((e)=>{
  ...
  const handleDelete = (post) =>{
    ...
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/deletePost",{postName,username})
      .then((e)=>{
  ...
  const handleButton = () =>{
    ...
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/showFriendList",{username})
      .then((e)=>{
        console.log(e.data)
  ...
  const handleUnfriend = (item) =>{
    ...
    console.log(sender)
    axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/unFriend",{sender})
      .then((e)=>{
        if(e.data==="success")
        alert("unfriend")
      window.location.reload()
