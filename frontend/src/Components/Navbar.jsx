...
const Navbar = () => {
    ...
    const handleNotification = () =>{
     ...
     axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/showfriendrequests",{username})
      .then((e)=>{
    ...
    const handleAccept = async(item) =>{
      ...
      try{
        const response = await axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/accept",{sender,receaver,profilepic})
        if(response.data==="success"){
          alert("Friend request accepted")
          const sender =  item.sender
      const receaver =  item.receaver
      axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/deletefriendrequests",{sender,receaver})
    .then(()=>{
    ...
    const showfriendrequests = () =>{
      axios.post("https://social-media-mern-with-cloudnaryy.vercel.app/api/showfriendrequests",{username})
      .then((e)=>{
        // console.log("this is for friend requests",e.data)
        setNotiFiData(e.data)
      })
